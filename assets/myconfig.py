...
#
# DC_TWO_WHEEL_PIGPIO - original TA7291P Motor Driver
# LEFT MOTOR
PWM_RANGE=255
PWM_FREQ=50
...
PI_HOSTNAME = "192.168.8.104"   # the network hostname or ip address
PI_DONKEY_ROOT = "/home/pi/projects/nakano"   # the location of the mycar dir on the pi. this will be used to help locate the final model destination.
...
# Set recording during throttle is not 0
AUTO_RECORD_ON_THROTTLE = True
# Use ELECOM JC-U3912T Controller in parts/controller.py
#CONTROLLER_TYPE='JCU3912T'
# Use PS3 Controller for Two Wheels Dozer in parts/controller.py
#CONTROLLER_TYPE='PS3TwoWheels'
# Use PS4 Dialshock Controller for Two Wheels Dozer in parts/controller.py
CONTROLLER_TYPE='PS4TwoWheels'

# Adjust 0 setting for analog pad 
JOYSTICK_DEADZONE = 0.1
# swicth reverse at horizontal values and vettical ones
...
AI_LAUNCH_ENABLE_BUTTON = 'options'         # this keypress will enable this boost. It must be enabled before each use to prevent accidental trigger.
